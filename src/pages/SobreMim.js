...
function SobreMim() {
    return (
        ...
        <section className="mt-20 p-4 md:p-0">
            <div>
                <h2 className='text-secondary text-[24px] md:text-[42px] font-bold mb-6'>About Me</h2>
            ...
            <div className="my-6">
                <h2 className='text-secondary text-[24px] md:text-[42px]  font-bold '>Work Experience</h2>
                <CardExperience />

            </div>
            <div>
                <h2 className='text-secondary text-[24px] md:text-[42px]  font-bold'>Education</h2>
                <CardEducation />
